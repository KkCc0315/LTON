...
public class DriverFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        input_name = view.findViewById(R.id.enterNameD);
        input_contact = view.findViewById(R.id.enterContactD);
        input_price = view.findViewById(R.id.enterPriceD);
        input_destination = view.findViewById(R.id.enterDestinationD);

        datePickerButton = view.findViewById(R.id.D_datePickerButton);
        selectedDateTimeTextView = view.findViewById(R.id.D_selectedDateTimeTextView);
        calendar = Calendar.getInstance();
        submit = view.findViewById(R.id.D_submitButton);
        notification = view.findViewById(R.id.D_successful);
        errorMessage = view.findViewById(R.id.errorMessageD);
        priceMessage = view.findViewById(R.id.priceMessageD);
        psg = view.findViewById(R.id.passengerD);
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (checkEmpty()) {
                    ...
                    // Construct new data string for driver
                    String newData = "Driver\n" + "Name: " + input_name.getText().toString() + "\n"
                    ...
                    DatabaseReference driverRef = mDatabase.child("driver");
        ...
        psg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AddFragment passengerFragment = new AddFragment();
                replaceFragment(passengerFragment);
            }
        });
        return view;
    }
